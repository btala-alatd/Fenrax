...
export const THEMES = [
  ...
  },
  {
    ...
    world:
      "Church and worship apparel. The message is Scripture — a short true verse plus its citation, set in considered type that could only belong to this house. Joyful, wearable. Fun like a good Sunday, never sarcastic, never a meme about God. Original geometry, not clipart. Never the Amazon default verses (John 3:16 / Phil 4:13 / Jer 29:11) unless the designer typed that verse. For kids: invented joyful marks, never gift-shop Jesus. Never copy Hillsong, Elevation, Passion, He Gets Us, or any church logo.",
    schools:
